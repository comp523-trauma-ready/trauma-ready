...
// Renders an individual activation card... essentially a digital recreation of 
// the paper version. Navigated to by tapping on an ActivationItem. 
// Props: 
...
export default class Activation extends React.Component {
  ...
  componentDidMount() {
    // Recieves an object representing an individual card with the form:
    // { 
    //   trauma: [String], aid: Number, name: String, 
    //   age: String, rac: String, notes: String 
    // }
